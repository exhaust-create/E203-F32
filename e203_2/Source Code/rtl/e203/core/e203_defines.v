...
`endif//}
`ifdef E203_CFG_HAS_FPU         // MY CODE
    `define E203_HAS_FPU
`endif
...
//
  ...
  // Classified by myself. Onlu support single-precision FP, so FPU_WIDTH = 1
  `define E203_DECINFO_GRP_FPU_WIDTH    1
//  `define E203_DECINFO_GRP_FPU_FLSU     `E203_DECINFO_GRP_FPU_WIDTH'd0
  `define E203_DECINFO_GRP_FPU_FMAC     `E203_DECINFO_GRP_FPU_WIDTH'd0
  `define E203_DECINFO_GRP_FPU_FMIS     `E203_DECINFO_GRP_FPU_WIDTH'd1
...
//  // Not Use FLSU
// // FLSU group, 8 bits including FPU group, starts from `E203_DECINFO_RV32
...
//`define E203_DECINFO_FLSU_WIDTH  (`E203_DECINFO_FLSU_OP2IMM_MSB+1)
  ...
  // FMIS group, 22 bits including FPU group, starts from `E203_DECINFO_RV32
...
`define E203_DECINFO_FMIS_WIDTH  (`E203_DECINFO_FMIS_DOUBLE_MSB+1)
  ...
  // FMAC group, 20 bits including FPU group, starts from `E203_DECINFO_RV32
  ...
  `define E203_DECINFO_FMAC_FLE  `E203_DECINFO_FMAC_FLE_MSB:`E203_DECINFO_FMAC_FLE_LSB
      `define E203_DECINFO_FMAC_DIV_LSB   (`E203_DECINFO_FMAC_FLE_MSB+1)
      `define E203_DECINFO_FMAC_DIV_MSB   (`E203_DECINFO_FMAC_DIV_LSB+1-1)    
  `define E203_DECINFO_FMAC_DIV   `E203_DECINFO_FMAC_DIV_MSB:`E203_DECINFO_FMAC_DIV_LSB 
      `define E203_DECINFO_FMAC_SQRT_LSB   (`E203_DECINFO_FMAC_DIV_MSB+1)
      `define E203_DECINFO_FMAC_SQRT_MSB   (`E203_DECINFO_FMAC_SQRT_LSB+1-1)    
  `define E203_DECINFO_FMAC_SQRT   `E203_DECINFO_FMAC_SQRT_MSB:`E203_DECINFO_FMAC_SQRT_LSB
      `define E203_DECINFO_FMAC_DOUBLE_LSB  (`E203_DECINFO_FMAC_SQRT_MSB+1)
